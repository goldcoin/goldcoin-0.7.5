...
Setup
-----
Unpack the files into a directory and run gldcoin-qt.exe.

If you have Microsoft Security Essentials, you need to add gldcoin-qt.exe to its
"Excluded processes" list.  Microsoft Security Essentials->Settings tab,
select Excluded processes, press Add, select gldcoin-qt.exe, OK, Save changes.
