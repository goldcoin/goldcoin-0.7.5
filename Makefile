...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Wed Nov 27 02:12:13 2013
# Project:  bitcoin-qt-win.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec c:\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=release RELEASE=1 USE_UPNP=1 USE_IPV6=1 USE_QRCODE=1 -o Makefile bitcoin-qt-win.pro
#############################################################################
...
Makefile: bitcoin-qt-win.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=release RELEASE=1 USE_UPNP=1 USE_IPV6=1 USE_QRCODE=1 -o Makefile bitcoin-qt-win.pro
