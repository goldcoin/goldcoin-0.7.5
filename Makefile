...
# Generated by qmake (2.01a) (Qt 4.8.4) on: Sun Jun 30 18:11:07 2013
# Project:  bitcoin-qt-win.pro
# Template: app
# Command: c:\Qt\4.8.4\bin\qmake.exe -spec c:\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=release UNPN=1 -o Makefile bitcoin-qt-win.pro
#############################################################################
...
Makefile: bitcoin-qt-win.pro  c:/Qt/4.8.4/mkspecs/win32-g++/qmake.conf c:/Qt/4.8.4/mkspecs/features/device_config.prf \
	...
	$(QMAKE) -spec c:\Qt\4.8.4\mkspecs\win32-g++ CONFIG+=release UNPN=1 -o Makefile bitcoin-qt-win.pro
