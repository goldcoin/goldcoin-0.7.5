.file	"aes-586.s"
.text
.def	__x86_AES_encrypt_compact;	.scl	3;	.type	32;	.endef
.align	16
...
.L000loop:
	...
	xorl	28(%edi),%edx
	ret
.def	__sse_AES_encrypt_compact;	.scl	3;	.type	32;	.endef
.align	16
...
.L002out:
	...
	pxor	8(%edi),%mm4
	ret
.def	__x86_AES_encrypt;	.scl	3;	.type	32;	.endef
.align	16
__x86_AES_encrypt:
	movl	%edi,20(%esp)
	xorl	(%edi),%eax
...
.long	0,0,0,0
.globl	_AES_encrypt
.def	_AES_encrypt;	.scl	2;	.type	32;	.endef
.align	16
_AES_encrypt:
.L_AES_encrypt_begin:
	pushl	%ebp
...
.L005x86:
	...
	popl	%ebp
	ret
.def	__x86_AES_decrypt_compact;	.scl	3;	.type	32;	.endef
.align	16
...
.L006loop:
	...
	xorl	28(%edi),%edx
	ret
.def	__sse_AES_decrypt_compact;	.scl	3;	.type	32;	.endef
.align	16
...
.L008out:
	...
	pxor	8(%edi),%mm4
	ret
.def	__x86_AES_decrypt;	.scl	3;	.type	32;	.endef
.align	16
__x86_AES_decrypt:
	movl	%edi,20(%esp)
	xorl	(%edi),%eax
...
.byte	225,105,20,99,85,33,12,125
.globl	_AES_decrypt
.def	_AES_decrypt;	.scl	2;	.type	32;	.endef
.align	16
_AES_decrypt:
.L_AES_decrypt_begin:
	pushl	%ebp
...
.def	_AES_cbc_encrypt;	.scl	2;	.type	32;	.endef
.align	16
_AES_cbc_encrypt:
...
.long	2767451785
	...
	popl	%ebp
	ret
.def	__x86_AES_set_encrypt_key;	.scl	3;	.type	32;	.endef
.align	16
...
.def	_private_AES_set_encrypt_key;	.scl	2;	.type	32;	.endef
.align	16
...
.def	_private_AES_set_decrypt_key;	.scl	2;	.type	32;	.endef
.align	16
