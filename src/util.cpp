...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "goldcoin.conf"));
                    ...
                    map<string, vector<string> >& mapMultiSettingsRet)
{
    ...
    {
        // Don't overwrite existing settings so command line settings override goldcoin.conf
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "goldcoind.pid"));
